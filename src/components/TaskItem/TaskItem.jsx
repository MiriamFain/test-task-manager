...
const TaskItem = ({
  ...
  const onSubmit = () => {
    handleEdit({ taskId: id, description: newDesc });
    setIsEditing(false);
  };
    ...
    <div className="task-item">
      <div className="item-left">
        <Button
          ...
          onClick={() => onComplete({ taskId: id, isComplete: !isCompleted })}
        >
          <AiOutlineCheck />
        </Button>
        <div className="task-desc">
          {isEditing ? (
            ...
            <>
              <span className={`desc ${isCompleted ? "complete-desc" : ""}`}>
                {description}
              </span>
              <span className="date">Create at: {formattedCreatedDate}</span>
              {isCompleted ? (
                <span className="date">
              ...
              {isDeleted ? (
                <span className="date">Deleted at: {formattedDeletedDate}</span>
              ) : (
                ""
              )}
            </>
        ...
        {isEditing ? (
          ...
          <>
            ...
            <button
              ...
              onClick={() =>
                handleMarkImportant({ taskId: id, isImportant: !important })
              }
            >
              Important
            </button>
            <button
              ...
              onClick={() =>
                handleMarkUrgent({ taskId: id, isUrgent: !urgent })
              }
            >
              Urgent
            </button>
